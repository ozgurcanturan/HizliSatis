...
namespace ProgramRestore
{
    public partial class Form1 : Form
    {
        ...
        private void bSec_Click(object sender, EventArgs e)
        {
            ...
            ofd.Filter = "Veri dosyasını seçiniz |*.bak"; //veri dosyası seçtirme |*.bak sadece bakları seçer mesela
            ofd.ShowDialog();
        ...
        private void bYukle_Click(object sender, EventArgs e)
        {
            if (tDosya.Text != "")
            {
                try
                {
                    ...
                    MessageBox.Show("Yedek Yüklenmiştir.");
                    Process.Start(Application.StartupPath + @"\HızlıSatis.exe");

...
namespace HızlıSatis
{
    public partial class fSatis : Form
    {
        ...
        private void HizliButonDoldur()
        {
            ...
            {
                Button bH = this.Controls.Find("bH" + item.Id, true).FirstOrDefault()
 as Button;
                if (bH != null)
                {
        ...
        private void bDigerUrun_Click(object sender, EventArgs e)
        {
            if (tNumarator.Text != "")
            {
                ...
                gridSatisListesi.Rows[satirsayisi].Cells["Fiyat"].Value = Islemler.DoubleYap(tNumarator.Text);//conver todouble değiştirdim
                gridSatisListesi.Rows[satirsayisi].Cells["KdvTutari"].Value = 0;
                gridSatisListesi.Rows[satirsayisi].Cells["Toplam"].Value = Islemler.DoubleYap(tNumarator.Text);//conver todouble değiştirdim
        ...
        //private void bIade1_Click(object sender, EventArgs e)
        //{

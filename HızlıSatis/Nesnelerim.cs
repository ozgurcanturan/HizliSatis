...
namespace HızlıSatis
{
    ...
    class bStandart : Button
    {
        public bStandart()
        {
            ...
            this.Name = "bStandart";
            this.Size = new System.Drawing.Size(106, 128);
            this.Text = "Standart Button";
    ...
    class tNumeric:TextBox
    {
        ...
        {
            if (char.IsDigit(e.KeyChar)==false&&e.KeyChar!=(char)08 && e.KeyChar!=44)
            {
                e.Handled = true;
            }
        }
    ...
    class gridOzel:DataGridView
    {
        public gridOzel()
        {
            ...
            this.Location = new System.Drawing.Point(4, 127);
            ...
            this.Size = new System.Drawing.Size(532, 511);
        }
    }
}
